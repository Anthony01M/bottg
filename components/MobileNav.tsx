    ...
    return (
        <div className="fixed bottom-0 left-0 right-0 bg-background border-t border-border z-10">
            <div className="grid grid-cols-3 max-w-md mx-auto relative">
                ...
                {/* Center section with special button */}
                <div className="flex justify-center relative">
                    ...
                    >
                        <div className={cn(
                            ...
                            pathname === centerItem.path ? "bg-primary-dark" : "bg-primary"
                        )}>
                            <centerItem.icon className={cn(`h-7 w-7 ${pathname === centerItem.path ? "text-primary" : "text-primary-foreground" }`)} />
                        </div>
                        <span className={cn(
                            "text-xs mt-1",
                            pathname === centerItem.path ? "text-primary" : "text-muted-foreground"
                        )}>
                            {centerItem.label}
                        </span>
                    </button>
