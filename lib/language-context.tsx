...
const translations: TranslationsType = {
	en: {
		...
		text2img: 'text2img',
		text2imgGenerator: 'Text to Image Generator',
		img2img: 'img2img',
		img2imgGenerator: 'Image to Image Generator',
		upscale: 'upscale',
	...
	ru: {
		...
		text2img: 'text2img',
		text2imgGenerator: 'Генератор Текст в Изображение',
		img2img: 'img2img',
		img2imgGenerator: 'Генератор Изображение в Изображение',
		upscale: 'Увеличение',
		upscaleTitle: 'Увеличение',
		prompt: 'Промпт',
